...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "Projects",
          description: "Selected Research &amp; Applied Project",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-urban-mobility-network-analysis-amp-forecasting-with-attention-mechanisms-and-graph-neural-networks",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%68%73.%73%68%6F%6E%39%31@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=2Ec5xyMAAAAJ&hl=ko", "_blank");
        },
      },{
      id: 'light-theme',
